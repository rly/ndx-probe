...
# -*- coding: utf-8 -*-
#
# ndx-probe documentation build configuration file, created by
# sphinx-quickstart on Mon Nov 25 20:58:12 2019.
#
...
htmlhelp_basename = 'ndx-probedoc'
...
latex_documents = [
    (master_doc, 'ndx-probe.tex', 'ndx-probe Documentation',
     'Ryan Ly', 'manual'),
]
...
man_pages = [
    (master_doc, 'ndx-probe', 'ndx-probe Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'ndx-probe', 'ndx-probe Documentation',
     author, 'ndx-probe', 'One line description of project.',
     'Miscellaneous'),
]
